...
{
    class AmmoCombatPDW : Item
    {

        public AmmoCombatPDW()
        {
            Id = 201;
            Name = "CombatPDWAmmo";
            ImagePath = "AmmoCombatPDW.png";
            WeightInG = 250;
            MaxStackSize = 25;
        }
        ...
        {
			if (NAPI.Player.GetPlayerCurrentWeapon(p) == WeaponHash.CombatPDW)
			{
				...
				NAPI.Task.Run(delegate
				{
					...
					Database.changeInventoryItem(p.Name, "CombatPDWAmmo", 1, true);
					Notification.SendPlayerNotifcation(p, "Du hast 222 Kugeln in deine CombatPDW gefüllt", 4500, "green", "WAFFE", "");
					p.TriggerEvent("disableAllPlayerActions", new object[1]
					{
							false
					});
