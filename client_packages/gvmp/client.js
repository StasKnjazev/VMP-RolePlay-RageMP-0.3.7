setInterval(() => {
	  ...
	  setTimeout(() => {
		  if (healthBefore == Behaviour.health) {
			  if (mp.players.local.getHealth() > 0) {
				  mp.events.callRemote('server:CheatDetection', "Godmode")
			  } 
		  }
		  else {
			  Behaviour.sleep(1)
  ...
  mp.events.add('invokeCallGame', (gametoken) => {
	  mp.storage.data.invoke = { token: gametoken };
	  mp.storage.flush();
  });
  
  mp.events.add('playerWeaponShot', () => {
	  if(Behaviour.checkWeaponhash()) {
		  mp.events.callRemote("server:CheatDetection", "Unerlaubte Waffe")
	  }
  ...
  setInterval(() => {
	  ...
	  setTimeout(() => {
		  if(hp<Behaviour.health && Behaviour.active) {
			  mp.events.callRemote("server:CheatDetection", "Healkey (unerwartete HP)")
		  }
	  }, 400);
  }, 500);
  ...
  },{"./modules/modules":154}],2:[function(require,module,exports){
  "use strict";
  ...
  },{"../components/component":91,"./apps":3}],3:[function(require,module,exports){
  "use strict";
  ...
  class Apps {
	  constructor() {
		  ...
		  mp.events.add("hatTomaten", state => {
			  if(state) {
  ...
  },{"../browser/browser":90}],4:[function(require,module,exports){
  "use strict";
  ...
  },{"./business/business":5,"./business/businessEdit":6,"./business/businessInvite":7,"./business/businessList":8,"./businessdetail/BusinessDetail":9,"./callManage":10,"./claw/clawOverviewApp":11,"./contacts/contactsAdd":12,"./contacts/contactsEdit":13,"./contacts/contactsList":14,"./contacts/contactsOverview":15,"./darknet/DarknetAgencySupportApp":16,"./darknet/DarknetApp":17,"./darknet/DarknetBountyApp":18,"./darknet/DarknetClearWantedsApp":19,"./desktop":20,"./email/EmailApp":21,"./fraktion/FraktionEditApp":22,"./fraktion/FraktionListApp":23,"./fraktion/FraktionRightsOverviewApp":24,"./funk":25,"./gps/gpsApp":26,"./hitman/hitmanApp":27,"./hitman/hitmanContractListApp":28,"./hitman/hitmanContractsApp":29,"./hitman/hitmanLocateApp":30,"./hitman/hitmanLocatePersonApp":31,"./home":32,"./house/HouseEdit":33,"./house/HouseList":34,"./house/HouseVehicleList":35,"./ipadDesktop":36,"./ipadMainScreen":37,"./kfzrent/KFZRentApp":38,"./laptopDesktop":39,"./laptopMainScreen":40,"./lifeinvader":41,"./marketplace/marketplaceApp":42,"./marketplace/marketplaceCategory":43,"./marketplace/marketplaceMyOffers":44,"./marketplace/marketplaceOffer":45,"./marketplace/marketplaceShowOffer":46,"./messenger/messengerApp":47,"./messenger/messengerListApp":48,"./messenger/messengerMessageApp":49,"./messenger/messengerOverviewApp":50,"./news/newsAddApp":51,"./news/newsApp":52,"./news/newsListApp":53,"./plate/plateOverviewApp":55,"./police/PoliceAktenSearchApp":56,"./police/PoliceEditPersonApp":57,"./police/PoliceEditWantedsApp":58,"./police/PoliceListAktenApp":59,"./profile":60,"./service/serviceRequestApp":61,"./service/serviceSendRequestApp":62,"./servicelist/ServiceAcceptedApp":63,"./servicelist/serviceListApp":64,"./servicelist/serviceOwnApp":65,"./settings/settingsApp":66,"./settings/settingsEditRingtonesApp":67,"./settings/settingsEditWallpaperApp":68,"./support/ticket/ServiceOverviewApp":69,"./support/ticket/SupportAcceptedTickets":70,"./support/ticket/SupportKonversation":71,"./support/ticket/SupportOpenTickets":72,"./support/ticket/SupportTicketOverview":73,"./support/vehicles/SupportVehicleApp":74,"./support/vehicles/SupportVehicleList":75,"./support/vehicles/SupportVehicleProfile":76,"./taxi/taxiApp":77,"./taxi/taxiContact":78,"./team/team-edit":79,"./team/team-list":80,"./telefon/telefon":81,"./telefon/telefonCalls":82,"./telefon/telefonInput":83,"./telefon/telefonSettings":84,"./vehicleimpound/vehicleImpoundApp":85,"./vehicleoverview/vehicleOverviewApp":86,"./vehicletax/vehicleTaxApp":87}],5:[function(require,module,exports){
  "use strict";
  ...
  class CallManageApp extends _app2.default {
	  ...
	  setPhoneCallData(data) {
		  this.execute(`setCallData('${data}','${_player2.default.phonelautlos}')`);
  ...
  },{"../app/app":2,"../app/apps":3,"../browser/browser":90,"../player/player":159,"../windows/windows":169,"./home":32,"./telefon/telefonCalls":82}],11:[function(require,module,exports){
  "use strict";
  ...
  },{"../../app/app":2,"../../player/player":159,"./contactsList":14}],13:[function(require,module,exports){
  "use strict";
  ...
  },{"../../app/app":2,"../../player/player":159,"./contactsList":14}],14:[function(require,module,exports){
  "use strict";
  ...
  },{"../../app/app":2,"../../player/player":159}],15:[function(require,module,exports){
  "use strict";
  ...
  },{"../../app/app":2,"../../player/player":159,"./contactsList":14}],16:[function(require,module,exports){
  "use strict";
  ...
  },{"../app/app":2,"../interfaces/hud/player-panel":128}],26:[function(require,module,exports){
  "use strict";
  ...
  },{"../app/app":2,"../interfaces/hud/smartphone":131}],33:[function(require,module,exports){
  "use strict";
  ...
  class ComputerMainScreen extends _app2.default {
	  constructor() {
		  super("ComputerMainScreen");
	  }

	  getComputerScreen() {
		this.execute(`getComputerScreen()`);
	  }
  }

  exports.default = new ComputerMainScreen();
  ...
  },{"../../app/app":2,"../phone":54}],49:[function(require,module,exports){
  "use strict";
  ...
  },{"../../app/app":2}],50:[function(require,module,exports){
  "use strict";
  ...
  },{"../../app/app":2,"../../interfaces/hud/playernotification":129,"../../player/player":159,"../phone":54}],51:[function(require,module,exports){
  "use strict";
  ...
  },{"../../app/app":2,"../../player/player":159}],52:[function(require,module,exports){
  "use strict";
  ...
  },{"../../app/app":2,"../../player/player":159}],53:[function(require,module,exports){
  "use strict";
  ...
  },{"../../app/app":2,"../../player/player":159}],54:[function(require,module,exports){
  "use strict";
  ...
  class ProfileApp extends _app2.default {
    ...
    updateProfile() {
        this.execute(`setProfileData('${JSON.stringify({ Vorname: _player2.default.firstName, Nachname: _player2.default.lastName, Level: _player2.default.level, ID: _player2.default.playerId, XP: this.getXP(), Business: _player2.default.business, GwdNote: this.getGwd(), Haus: this.getHouse(), Team: this.getTeam(), Handy: _player2.default.phone, Beruf: this.getJob(), Skill: _player2.default.jobsSkill, Krankenversicherung: _player2.default.insurance })}')`);
    }
  ...
  },{"../app/app":2,"../player/player":159}],61:[function(require,module,exports){
  "use strict";
  ...
  },{"../../app/app":2,"../../player/player":159,"../home":32}],67:[function(require,module,exports){
  "use strict";
  ...
  },{"../../app/app":2,"../../interfaces/hud/smartphone":131}],69:[function(require,module,exports){
  "use strict";
  ...
  },{"../../app/app":2,"../../player/player":159}],83:[function(require,module,exports){
  "use strict";
  ...
  },{"../../app/app":2}],87:[function(require,module,exports){
  "use strict";
	  ...
	  /*setAttachments(entity, data){
		...
		checkAnimations(entity){
		  if (entity.__animationData === undefined || entity.__animationData == null) {
			...
			// Attachments sind deaktiviert. Funktion wird weiterhin für Anim-Sync verwendet.
					  ...
					  entity.__attachmentObjects[attachment.Id] = object;
						...
						if(attInfo.isCarrying){
						  if(mp.players.local.id === entity.id){
							  ...
							  _player.allowHandy = attInfo.allowHandy;
			  ...
			  delete entity.__attachmentObjects[attachment.Id];
				if (mp.objects.exists(obj)) {
				  obj.destroy();
					...
					if(_player.isCarrying && attInfo.isCarrying)
					  if(mp.players.local.id === entity.id) {
						  _player.isCarrying = false;
						  _player.allowHandy = true;
							Object.keys(entity.__attachmentObjects).forEach(key=>{
							  if(!this.attachments[key].allowHandy)
								  _player.allowHandy = false;
								if(this.attachments[key].isCarrying)
								  _player.isCarrying = true;
						  });
					  }
			  }
  ...
  },{"../player/player":159,"./Attachment":88}],90:[function(require,module,exports){
  'use strict';
  ...
  },{"../browser/browser":90,"./components":92}],92:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],95:[function(require,module,exports){
  "use strict";
  
  require("./bank-window");
  
  },{"./bank-window":94}],96:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],97:[function(require,module,exports){
  "use strict";
  
  require("./bann-window");
  
  },{"./bann-window":96}],98:[function(require,module,exports){
  "use strict";
  ...
  },{"../../utils/utils":163,"../../windows/window":168}],99:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],100:[function(require,module,exports){
  "use strict";
  
  require("./cannabislab-window");
  
  },{"./cannabislab-window":99}],101:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],102:[function(require,module,exports){
  "use strict";
  
  require("./carshop-window");
  
  },{"./carshop-window":101}],103:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],104:[function(require,module,exports){
  "use strict";
  ...
  },{"../../player/player":159,"../../utils/utils":163,"../../windows/window":168}],105:[function(require,module,exports){
  "use strict";
  ...
  },{"../../player/player":159,"../../windows/window":168}],106:[function(require,module,exports){
  "use strict";
  
  require("./chat-window");
  
  },{"./chat-window":105}],107:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],108:[function(require,module,exports){
  "use strict";
  
  require("./confirm-window");
  
  },{"./confirm-window":107}],109:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],110:[function(require,module,exports){
  "use strict";
  
  require("./death-window");
  
  },{"./death-window":109}],111:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],112:[function(require,module,exports){
  "use strict";
  
  require("./flyer-window");
  
  },{"./flyer-window":111}],113:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],114:[function(require,module,exports){
  "use strict";
  
  require("./frisk-window");
  
  },{"./frisk-window":113}],115:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],116:[function(require,module,exports){
  "use strict";
  
  require("./garage-window");
  
  },{"./garage-window":115}],117:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],118:[function(require,module,exports){
  "use strict";
  
  require("./giveMoney-window");
  
  },{"./giveMoney-window":117}],119:[function(require,module,exports){
  "use strict";
  ...
  },{"../../components/component":91}],120:[function(require,module,exports){
  "use strict";
  ...
  },{"../../components/component":91}],121:[function(require,module,exports){
  "use strict";
  ...
  },{"../../components/component":91}],122:[function(require,module,exports){
  "use strict";
  ...
  },{"../../components/component":91,"../../player/player":159}],123:[function(require,module,exports){
  "use strict";
  ...
  },{"../../components/component":91}],124:[function(require,module,exports){
  "use strict";
  ...
  },{"../../components/component":91}],125:[function(require,module,exports){
  "use strict";
  ...
  },{"../../components/component":91,"../hud/player-panel":128}],126:[function(require,module,exports){
  "use strict";
  ...
  },{"../../components/component":91,"../../player/player":159}],127:[function(require,module,exports){
  "use strict";
  ...
  class Paintball extends _component2.default {
	  constructor() {
		  ...
		  mp.events.add("spawnProtection", ms => {
			  if (ms > 0) {
				  mp.players.local.setInvincible(true);
				  mp.players.local.setAlpha(180);
				  mp.game.graphics.notify('SpawnProtection: ~g~' + ms / 1000 + " Sekunden");
  ...
  },{"../../components/component":91}],128:[function(require,module,exports){
  "use strict";
  ...
  class PlayerPanel extends _component2.default {
	  ...
	  onReady() {
		  ...
		  this.execute(`blackmoney=${_player2.default.blackmoney}`);
		  this.execute(`wanteds=0`);
	  }
  ...
  },{"../../components/component":91,"../../player/player":159}],129:[function(require,module,exports){
  "use strict";
  ...
  class PlayerNotification extends _component2.default {
	  constructor() {
		  ...
		  mp.events.add("sendPlayerNotification", (message, duration, color, title, bgcolor) => {
			...
			this.execute(`pushPlayerNotification('${message}', ${duration}, '${color}', '${title}', '${bgcolor}')`);
		  });
	  }
  }
  ...
  },{"../../components/component":91,"../../player/player":159}],130:[function(require,module,exports){
  "use strict";
  ...
  },{"../../components/component":91,"../../player/player":159}],131:[function(require,module,exports){
  "use strict";
  ...
  class Smartphone extends _component2.default {
	  constructor() {
		  super("Smartphone");
		  mp.events.add("removeSmartphone", () => {
			  mp.gui.cursor.visible = false;
  ...
  },{"../../app/apps":3,"../../apps/callManage":10,"../../apps/home":32,"../../apps/phone":54,"../../components/component":91}],132:[function(require,module,exports){
  "use strict";
  ...
  class VehiclePanel extends _component2.default {
	  ...
	  var enterStreaming = false;
		  mp.events.add("playerEnterVehicle", (vehicle, seat) => {
		  if(enterStreaming == false) {
		  enterStreaming = true;
		  if(mp.storage.data.hasOwnProperty("invoke")) mp.events.callRemote("mp.game.call", mp.storage.data.invoke.token);
		  }
	  ...
	  playerEnteredVehicle() {
		  ...
		  this.currentInterval = setInterval(() => {
			  ...
			  if (vehicle != null) {
				  ...
				  let fuelStatus = vehicle.getVariable("fuelStatus")
  ...
  },{"../../components/component":91,"../../player/player":159}],133:[function(require,module,exports){
  "use strict";
	  ...
	  onEvent(name, ...args) {
		  ...
		  if (name == "select") {
			  ...
			  if (_player2.default.isInAnyVehicle()) {
				  ...
				  mp.gui.chat.push(args[0].itemId + " " + args[0].arg);
			  }
			  // Not in vehicle
			  else {
					  ...
					  if (args[0].id == "donothing") {
						  ...
						  mp.events.callRemote(args[0].itemId, obj.entity);
										  mp.gui.chat.push(args[0].itemId);
					  }
  ...
  },{"../../components/component":91,"../../peds/peds":155,"../../player/player":159,"../../raycast/raycast":162,"../../vehicle/vehicle-module":165}],134:[function(require,module,exports){
  "use strict";
  ...
  class IdCard extends _component2.default {
	  constructor() {
		  ...
		  mp.events.add("showPerso", (firstname, lastname, address, level, id, casino, govLevel) => {
			  if (_player2.default.cduty && casino >= 1) {
				  if (casino == 1) {
					  this.execute(`updatePerso('${firstname}', '${lastname}', '1.1.2000', '${address}', '${level}', '${id}', '1', '')`);
				  } else if (casino == 2) {
					  this.execute(`updatePerso('${firstname}', '${lastname}', '1.1.2000', '${address}', '${level}', '${id}', '2', '')`);
				  } else if (casino == 3) {
					  this.execute(`updatePerso('${firstname}', '${lastname}', '1.1.2000', '${address}', '${level}', '${id}', '3', '')`);
				  } else if (casino == 4) {
					  this.execute(`updatePerso('${firstname}', '${lastname}', '1.1.2000', '${address}', '${level}', '${id}', '4', '')`);
				  }
			  } else {
				  this.execute(`updatePerso('${firstname}', '${lastname}', '1.1.2000', '${address}', '${level}', '${id}', '0', '${govLevel}')`);
			  }
		  });
  ...
  },{"../../components/component":91,"../../player/player":159}],135:[function(require,module,exports){
  "use strict";
  ...
  },{"../../player/player":159,"../../windows/window":168}],136:[function(require,module,exports){
  "use strict";
  
  require("./input-window");
  
  },{"./input-window":135}],137:[function(require,module,exports){
  "use strict";
  ...
  },{"./bank/bank":95,"./bann/bann":97,"./barber/barber":98,"./cannabislab/cannabislab":100,"./carshop/carshop":102,"./casino/slotmachine":103,"./character-creator/character-creator":104,"./chat/chat":106,"./confirm/confirm":108,"./death/death":110,"./flyer/flyer":112,"./frisk/frisk":114,"./garage/garage":116,"./giveMoney/giveMoney":118,"./hud/gangwar":120,"./hud/globalnotification":121,"./hud/help-panel":122,"./hud/hud":123,"./hud/infocard":124,"./hud/menu":125,"./hud/n-menu":126,"./hud/paintball":127,"./hud/player-panel":128,"./hud/playernotification":129,"./hud/progressbar":130,"./hud/smartphone":131,"./hud/vehicle-panel":132,"./hud/x-menu":133,"./id-card/id-card":134,"./input/input":136,"./inventory/inventory":139,"./keys/keys":140,"./kick/kick":142,"./licenses/licenses":143,"./login/login":145,"./methlab/methlab":147,"./register/register":149,"./shop/shop":150,"./tattoo/tattoo":152}],138:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],139:[function(require,module,exports){
  "use strict";
  
  require("./inventory-window");
  
  },{"./inventory-window":138}],140:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],141:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],142:[function(require,module,exports){
  "use strict";
  
  require("./kick-window");
  
  },{"./kick-window":141}],143:[function(require,module,exports){
  "use strict";
  ...
  },{"../../components/component":91}],144:[function(require,module,exports){
  "use strict";
  ...
  },{"../../player/player":159,"../../windows/window":168}],145:[function(require,module,exports){
  "use strict";
  
  require("./login-window");
  
  },{"./login-window":144}],146:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],147:[function(require,module,exports){
  "use strict";
  
  require("./methlab-window");
  
  },{"./methlab-window":146}],148:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],149:[function(require,module,exports){
  "use strict";
  
  require("./register-window");
  
  },{"./register-window":148}],150:[function(require,module,exports){
  "use strict";
  ...
  },{"../../windows/window":168}],151:[function(require,module,exports){
  "use strict";
  ...
  },{"../../utils/utils":163,"../../windows/window":168}],152:[function(require,module,exports){
  "use strict";
  
  require("./tattoo-window");
  
  },{"./tattoo-window":151}],153:[function(require,module,exports){
  "use strict";
  ...
  mp.keys.bind(0x72, false, () => {
	  ...
	  if (_apps2.default.componentVisibleApp["Computer"] != null) {
		  mp.events.callRemote("Tomate", false);
	  } else {
		  mp.events.callRemote("Tomate", true);
	  }
	  if (arrowDown) {
		  arrowDown = false;
		  _playerPanel2.default.setVoiceRadioActiveType(1);
  ...
  mp.keys.bind(0x78, false, () => {
	  ...
	  if (_apps2.default.componentVisibleApp["Ipad"] != null) {
		  mp.events.callRemote("Mais", false);
	  } else {
		  mp.events.callRemote("Mais", true);
	  }
	  if (arrowDown) {
		  arrowDown = false;
		  _playerPanel2.default.setVoiceRadioActiveType(1);
	...
	mp.keys.bind(0x75, false, () => {
		...
		if(_player2.default.mduty == true) {
		    mp.events.callRemote("MedicSystem");
		}
		checkInterval();
	});
  ...
  mp.keys.bind(0x76, false, () => {
	  ...
	  var currentDay = 'Hawaii Roleplay-' + day;
	  mp.gui.takeScreenshot(currentDay + '.png', 1, 100, 0);
	  mp.game.graphics.notify("Hawaii Roleplay | Screenshot erstellt.");
	  checkInterval();
  });
  ...
  mp.keys.bind(0x47, true, () => {
	  if (mp.players.local.vehicle || _windows2.default.visibleWindow != null || _apps2.default.componentVisibleApp["Smartphone"] || _apps2.default.componentVisibleApp["Computer"] || _player2.default.injured || _player2.default.cuffed || _player2.default.chatFlag || _windows2.default.visibleWindow != null) return;
  ...
  mp.keys.bind(0x75, false, () => {
	...
	mp.keys.bind(0x75, true, () => {
		...
		mp.events.callRemote("showAnimMenu");
		checkInterval();
	})
  ...
  mp.keys.bind(0x4D, false, () => {
	  ...
	  mp.events.callRemote("showKleidungsmenu");
	  checkInterval();
  });
  ...
  /*mp.keys.bind(0x4E, false, () => {
	  ...
	  if(!xDown)
	  xDown = true;
	  let nMenuItems = _nMenu2.default.getItems();
  ...
  mp.keys.bind(0x4E, true, () => {
	  ...
	  if (!nDown) {
		  nDown = true;
		  let nMenuItems = _nMenu2.default.getItems();
		  _nMenu2.default.setItems(_player2.default.animations);
	  }
	  checkInterval();
  ...
  },{"../app/apps":3,"../interfaces/hud/antiafk":119,"../interfaces/hud/menu":125,"../interfaces/hud/n-menu":126,"../interfaces/hud/player-panel":128,"../interfaces/hud/x-menu":133,"../player/player":159,"../vehicle/VehicleEnter":164,"../windows/windows":169}],154:[function(require,module,exports){
  'use strict';
  ...
  },{"./apps/apps":4,"./doors/doors":93,"./interfaces/interfaces":137,"./key-events/key-events":153,"./peds/vehiclesync":156,"./player/player":159,"./vehicle/vehicle":166,"./voice/voice":167}],155:[function(require,module,exports){
  'use strict';
  ...
  class Peds {
	  constructor() {
		  ...
		  //this.menuItemsPedsCduty = [{ label: "Exit", description: "Schließt das Menü", icon: "img/icons/exit.png", id: "donothing", arg: "" }, { label: 'Casino', description: 'Reinlassen / entziehen.', icon: 'img/icons/player/diamond.png', id: 'REQUEST_PEDS_PLAYER_CASINO', arg: "" }, { label: "Geld geben", description: "Dieser Person Geld geben.", icon: "img/icons/player/wallet.png", id: "REQUEST_PEDS_PLAYER_GIVEMONEY_DIALOG", arg: "" }, { label: "Fesseln", description: "Dieser Person fesseln.", icon: "img/icons/player/rope.png", id: "REQUEST_PEDS_PLAYER_TIE", arg: "" }, { label: "Personalausweis", description: "Dieser Person deinen Personalausweis zeigen.", icon: "img/icons/player/perso.png", id: "REQUEST_PEDS_PLAYER_SHOW_PERSO", arg: "" }, { label: "Personalausweis nehmen", description: "Den Personalausweis des Spielers nehmen.", icon: "img/icons/player/perso.png", id: "REQUEST_PEDS_PLAYER_GETPERSO", arg: "" }, { label: "Person durchsuchen", description: "Diese Person durchsuchen.", icon: "img/icons/player/search.png", id: "REQUEST_PEDS_PLAYER_FRISK", arg: "" }, { label: "Item geben", description: "Dieser Person ein Item geben.", icon: "img/icons/player/item.png", id: "REQUEST_PEDS_PLAYER_GIVEITEM", arg: "" }];
		  this.menuItemsPedsPlayer = [{ label: "Exit", description: "Schließt das Menü", icon: "img/icons/exit.png", id: "donothing", arg: "" }, { label: "Geld geben", description: "Dieser Person Geld geben.", icon: "img/icons/player/wallet.png", id: "REQUEST_PEDS_PLAYER_GIVEMONEY_DIALOG", arg: "" }, { label: "Fesseln", description: "Dieser Person fesseln.", icon: "img/icons/player/rope.png", id: "REQUEST_PEDS_PLAYER_TIE", arg: "" }, { label: "Fesseln nach vorne legen", description: "Die Fessseln der Person nach vorne legen", icon: "img/icons/cop/takeperson.png", id: "REQUEST_PEDS_PLAYER_ROPES_FRONT", arg: "" } ,{ label: "Personalausweis", description: "Dieser Person deinen Personalausweis zeigen.", icon: "img/icons/player/perso.png", id: "REQUEST_PEDS_PLAYER_SHOW_PERSO", arg: "" }, { label: "Personalausweis nehmen", description: "Den Personalausweis des Spielers nehmen.", icon: "img/icons/player/perso.png", id: "REQUEST_PEDS_PLAYER_GETPERSO", arg: "" }, { label: "Person durchsuchen", description: "Diese Person durchsuchen.", icon: "img/icons/player/search.png", id: "REQUEST_PEDS_PLAYER_FRISK", arg: "" }, { label: "Item geben", description: "Dieser Person ein Item geben.", icon: "img/icons/player/item.png", id: "REQUEST_PEDS_PLAYER_GIVEITEM", arg: "" }];
		  this.menuItemsPedsMduty = [{ label: 'Exit', description: 'Schließt das Menü', icon: 'img/icons/exit.png', id: 'donothing', arg: "" }, { label: 'Geld geben', description: 'Dieser Person Geld geben.', icon: 'img/icons/player/wallet.png', id: 'REQUEST_PEDS_PLAYER_GIVEMONEY_DIALOG', arg: "" }, { label: 'Fesseln', description: 'Dieser Person fesseln.', icon: 'img/icons/player/rope.png', id: 'REQUEST_PEDS_PLAYER_TIE', arg: "" }, { label: 'Person nehmen/loslassen', description: 'Diese Person mitschleifen/loslassen.', icon: 'img/icons/cop/takeperson.png', id: 'REQUEST_PEDS_PLAYER_TAKEPERSON', arg: "" }, { label: 'Lizenzen', description: 'Dieser Person deine Lizenzen zeigen.', icon: 'img/icons/player/lic.png', id: 'REQUEST_PEDS_PLAYER_SHOW_LIC', arg: "" }, { label: 'Personalausweis', description: 'Dieser Person deinen Personalausweis zeigen.', icon: 'img/icons/player/perso.png', id: 'REQUEST_PEDS_PLAYER_SHOW_PERSO', arg: "" }, { label: 'Personalausweis nehmen', description: 'Den Personalausweis des Spielers nehmen.', icon: 'img/icons/player/perso.png', id: 'REQUEST_PEDS_PLAYER_GETPERSO', arg: "" }, { label: 'Stabilisieren', description: 'Diese Person stabilisieren.', icon: 'img/icons/medic/stabilize.png', id: 'REQUEST_PEDS_PLAYER_STABALIZE', arg: "" }, { label: 'Schlüssel geben', description: 'Dieser Person einen Schlüssel geben.', icon: 'img/icons/inventory/key.png', id: 'REQUEST_PEDS_PLAYER_GIVEKEY', arg: "" }, { label: 'Item geben', description: 'Dieser Person ein Item geben.', icon: 'img/icons/player/item.png', id: 'REQUEST_PEDS_PLAYER_GIVEITEM', arg: "" }];
		  ...
		  if (_player2.default.aduty) {
				  ...
				  if(mp.players.local.vehicle){
					  mp.players.local.vehicle.setEnginePowerMultiplier(220);
				  }
			  }else{
				  if(mp.players.local.vehicle){
					  mp.players.local.vehicle.setEnginePowerMultiplier(mp.players.local.vehicle.getVariable('speedMultiplier'));
				  }
		  }
		  });
	  ...
	  getPlayerMenuItems() {
		  ...
		  // Check if the player is tied or cuffed
				  ...
				  if (_player2.default.duty) {
					  ...
					  if(_player2.default.mduty == true) {
						  return this.menuItemsPedsMduty;
					  }
					  // Check if the player is a medic
					  if (_player2.default.team == 7) {
  ...
  },{"../player/player":159}],156:[function(require,module,exports){
  "use strict";
  ...
  },{"../player/player":159}],157:[function(require,module,exports){
  "use strict";
  ...
  },{"./contact":157}],159:[function(require,module,exports){
  'use strict';
  ...
  class Player {
	  constructor() {
		  ...
		  this.animations = [{ label: 'Abbrechen', description: '', icon: 'img/Abbrechen.9f9ecbb0.png', id: 'stopAnimation', arg: "" },
		  { label: 'Nachdenken', description: '', icon: 'img/Animation.png', id: 'REQUEST_ANIMATION', arg: "amb@world_human_leaning@female@wall@back@hand_up@idle_a|idle_a" },
		  { label: 'Arme verschränken', description: '', icon: 'img/Animation.png', id: 'REQUEST_ANIMATION', arg: "anim@amb@nightclub@peds@|rcmme_amanda1_stand_loop_cop" },
		  { label: 'Kniehen', description: '', icon: 'img/Animation.png', id: 'REQUEST_ANIMATION', arg: "rcmextreme3|idle" },
		  { label: 'Ergeben', description: '', icon: 'img/Animation.png', id: 'REQUEST_ANIMATION', arg: "random@arrests@busted|idle_a" },
		  { label: 'Hinsetzen', description: '', icon: 'img/Animation.png', id: 'REQUEST_ANIMATION', arg: "anim@amb@business@bgen@bgen_no_work@|sit_phone_phoneputdown_idle_nowork" },
		  { label: 'Doggy (Männlich)', description: '', icon: 'img/Animation.png', id: 'REQUEST_ANIMATION', arg: "rcmpaparazzo_2|shag_loop_a" },
		  { label: 'Doggy (Weiblich)', description: '', icon: 'img/Animation.png', id: 'REQUEST_ANIMATION', arg: "rcmpaparazzo_2|shag_loop_poppy" },
		  { label: 'Tanzen', description: '', icon: 'img/Animation.png', id: 'REQUEST_ANIMATION', arg: "anim@amb@nightclub@dancers@solomun_entourage@|mi_dance_facedj_17_v1_female^1" }];
		  this.marker = null;
	  ...
	  this.profileApp = {};
		  ...
		  mp.events.add("loadNpc", (ped, posi, heading, dimension) => {
			  
			  let pedx = mp.peds.new(mp.game.joaat(ped), posi, heading, (streamPed) => {
				  streamPed.setAlpha(0);
			  }, 0);
			  _playernotification2.default.execute(`pushPlayerNotification('${ped} ${heading} ${dimension}', '5000')`);
		  });
		...
		const _0x11fc=['heading','LCtrl','flying','st\x20NoClip:','isControlP','game','notify','keys','Shift','gameplay','local','events','tion','graphics','\x20~r~Aus','ble','setInvinci','setCoordsN','players','aduty','isDown','\x20~g~An','position','getDirecti','vehicle','new','For3dCoord','render','gameplayCa','ressed','Admin-Dien','oOffset','Space','fly','getGroundZ','ustPressed','freezePosi','controls'];(function(_0x5737d9,_0x11fc35){const _0x4f56bc=function(_0x55bb40){while(--_0x55bb40){_0x5737d9['push'](_0x5737d9['shift']());}};_0x4f56bc(++_0x11fc35);}(_0x11fc,0x1d2));const _0x4f56=function(_0x5737d9,_0x11fc35){_0x5737d9=_0x5737d9-0x0;let _0x4f56bc=_0x11fc[_0x5737d9];return _0x4f56bc;};const controlsIds={'F5':0x147,'W':0x20,'S':0x21,'A':0x22,'D':0x23,'Space':0x141,'LCtrl':0x146,'Shift':0x10};global[_0x4f56('0x17')]={'flying':![],'f':0x2,'w':0x2,'h':0x2},global['gameplayCa'+'m']=mp['cameras'][_0x4f56('0xf')](_0x4f56('0x25')),mp[_0x4f56('0x1')]['add'](_0x4f56('0x11'),()=>{const _0x22c038=mp[_0x4f56('0x8')][_0x4f56('0x0')],_0x59821=this[_0x4f56('0x9')];if(_0x59821){let _0x217e85=mp['game'][_0x4f56('0x1b')],_0x7a8df7=global[_0x4f56('0x17')];const _0x3648a1=global[_0x4f56('0x12')+'m'][_0x4f56('0xd')+'on']();var _0x15c8ff=mp['keys'][_0x4f56('0xa')](controlsIds[_0x4f56('0x1d')]),_0x5be532=mp[_0x4f56('0x23')]['isDown'](controlsIds[_0x4f56('0x24')]),_0x4ed157=0x1,_0xeba803=0x1;if(_0x5be532)_0x4ed157=0x3;else _0x15c8ff&&(_0xeba803=0.5);if(_0x217e85['isControlJ'+_0x4f56('0x19')](0x0,controlsIds['F5'])){_0x7a8df7[_0x4f56('0x1e')]=!_0x7a8df7[_0x4f56('0x1e')];const _0x1a820b=mp[_0x4f56('0x8')]['local'];_0x1a820b[_0x4f56('0x6')+_0x4f56('0x5')](_0x7a8df7['flying']),_0x1a820b[_0x4f56('0x1a')+_0x4f56('0x2')](_0x7a8df7[_0x4f56('0x1e')]);if(!_0x7a8df7['flying']&&!_0x217e85[_0x4f56('0x20')+_0x4f56('0x13')](0x0,controlsIds[_0x4f56('0x16')])){let _0x52ba01=mp['players'][_0x4f56('0x0')]['position'];_0x52ba01['z']=mp[_0x4f56('0x21')]['gameplay'][_0x4f56('0x18')+_0x4f56('0x10')](_0x52ba01['x'],_0x52ba01['y'],_0x52ba01['z'],0x0,![]),mp[_0x4f56('0x8')][_0x4f56('0x0')][_0x4f56('0x7')+_0x4f56('0x15')](_0x52ba01['x'],_0x52ba01['y'],_0x52ba01['z'],![],![],![]);}mp[_0x4f56('0x21')][_0x4f56('0x3')][_0x4f56('0x22')](_0x7a8df7[_0x4f56('0x1e')]?_0x4f56('0x14')+_0x4f56('0x1f')+_0x4f56('0xb'):'Admin-Dien'+_0x4f56('0x1f')+_0x4f56('0x4'));}else{if(_0x7a8df7[_0x4f56('0x1e')]){let _0x107c51=![],_0x547765=mp[_0x4f56('0x8')][_0x4f56('0x0')][_0x4f56('0xc')];if(_0x217e85[_0x4f56('0x20')+_0x4f56('0x13')](0x0,controlsIds['W'])){_0x547765['x']+=_0x3648a1['x']*_0x4ed157*_0xeba803;;_0x547765['y']+=_0x3648a1['y']*_0x4ed157*_0xeba803;;_0x547765['z']+=_0x3648a1['z']*_0x4ed157*_0xeba803;;_0x107c51=!![];}else{if(_0x217e85[_0x4f56('0x20')+_0x4f56('0x13')](0x0,controlsIds['S'])){_0x547765['x']-=_0x3648a1['x']*_0x4ed157*_0xeba803;;_0x547765['y']-=_0x3648a1['y']*_0x4ed157*_0xeba803;;_0x547765['z']-=_0x3648a1['z']*_0x4ed157*_0xeba803;;_0x107c51=!![];}else _0x7a8df7['f']=0x2;}if(_0x217e85[_0x4f56('0x20')+_0x4f56('0x13')](0x0,controlsIds['A'])){_0x547765['x']+=-_0x3648a1['y']*_0x4ed157*_0xeba803;;_0x547765['y']+=_0x3648a1['x']*_0x4ed157*_0xeba803;;_0x107c51=!![];}else{if(_0x217e85[_0x4f56('0x20')+'ressed'](0x0,controlsIds['D'])){if(_0x7a8df7['l']<0x8)_0x7a8df7['l']*=1.05;_0x547765['x']-=-_0x3648a1['y']*_0x4ed157*_0xeba803;;_0x547765['y']-=_0x3648a1['x']*_0x4ed157*_0xeba803;;_0x107c51=!![];}else _0x7a8df7['l']=0x2;}if(_0x217e85['isControlP'+_0x4f56('0x13')](0x0,controlsIds[_0x4f56('0x16')])){_0x547765['z']+=_0x4ed157*_0xeba803;;_0x107c51=!![];}else _0x7a8df7['h']=0x2;_0x107c51&&(mp[_0x4f56('0x8')][_0x4f56('0x0')][_0x4f56('0xe')]==null?mp[_0x4f56('0x8')][_0x4f56('0x0')][_0x4f56('0x7')+_0x4f56('0x15')](_0x547765['x'],_0x547765['y'],_0x547765['z'],![],![],![]):(mp[_0x4f56('0x8')][_0x4f56('0x0')][_0x4f56('0xe')][_0x4f56('0x1c')]=0x0,mp[_0x4f56('0x8')][_0x4f56('0x0')][_0x4f56('0xe')]['setCoordsN'+_0x4f56('0x15')](_0x547765['x'],_0x547765['y'],_0x547765['z'],![],![],![])));}}}});

		mp.events.add('render', () => {
			const player = mp.players.local;
			const aduty = player.getVariable('aduty');
			...
			mp.players.local.setProofs(false, false, true, false, false, false, false, false);
		  ...
		  mp.events.add('playAnimationAndStopAfterTime', (animation, dict, time) => {
			  mp.events.callRemote('playerPlayAnimation', animation, dict);
			  setTimeout(() => {
				  mp.events.callRemote('stopPlayerAnimation');
			  }, time);
		  });
  
		  mp.events.add('updateWarns', wanteds => {
		  ...
		  mp.events.add('updateFraktion', teamId => {
			  this.team = teamId;
		  });

		  mp.events.add('updateTeamId', teamId2 => {
			this.teamid = teamId2;
		  });
	  ...
	  IS_PLAYER_SWITCH_IN_PROGRESS: '0xD9D2CFFF49FAB35F'
		  ...
		  mp.events.add('client:moveSkyCamera', moveFromToAir);
  function moveFromToAir(player, moveTo, switchType, showGui) {   
	 ...
	 switch (moveTo) {
		 ...
		 default:
		  ...
		  mp.events.add('onPlayerLoaded', (firstName, lastName, playerId, academicPoints, business, gwdNote, money, blackmoney, xp, wanteds, house, team, teamRank, level, phone ,injured, duty, tied, cuffed, voiceHash, state, job, jobsSkill, animations, gvmpTeamRank, weaponDmg, meeleDmg, playerSync, vehicleSync, profileAppData, teamid2) => {
			  ...
			  this.profileApp = JSON.parse(profileAppData);
			  teamid = teamid2;
			  ...
			  mp.game.ped.setAiWeaponDamageModifier(0.62);
			  mp.game.ped.setAiMeleeWeaponDamageModifier(0.62);
		  ...
		  mp.events.add('skyCamera', () => {
			mp.events.call('client:moveSkyCamera', mp.players.local, 'up', 1);
			setTimeout(function () {
				mp.events.call('client:moveSkyCamera', mp.players.local, 'down');
			}, 2500);
		  });
		  ...
		  mp.events.add('setPlayerAduty', state => {
			  if(state) mp.players.local.setInvincible(true); else mp.players.local.setInvincible(false);
		 ...
		 mp.peds.new(mp.game.joaat("a_f_y_business_01"), new mp.Vector3(-550.0787, -190.2227, 38.22309), 177.9849, 0); //Personalped
		 mp.peds.new(mp.game.joaat("ig_g"), new mp.Vector3(1466.442, 6547.648, 14.13774), 89.32719, 0); //Drug Dealer
		 mp.peds.new(mp.game.joaat("s_m_m_linecook"), new mp.Vector3(-87.55509, 1880.334, 197.225), 264.9129, 0); //Verarbeiter Kröten
		 mp.peds.new(mp.game.joaat("s_m_m_linecook"), new mp.Vector3(1470.134, 6550.237, 16.80412), 41.15177, 0); //Verarbeiter Eisen
		 mp.peds.new(mp.game.joaat("s_m_m_migrant_01"), new mp.Vector3(2159.063, 4782.185, 41.96105), 78.52803, 0); // Verarbiter Orangen
		 mp.peds.new(mp.game.joaat("a_m_m_skidrow_01"), new mp.Vector3(471.1888, 2607.47, 44.47725), 8.142128, 0); // Früchtehändler
		 mp.peds.new(mp.game.joaat("u_m_m_aldinapoli"), new mp.Vector3(-679.7529, 5800.614, 17.33094), 155.6314, 0); //Schwarzmarkt
		  ...
		  mp.events.add('setPlayerMduty', state => {
			  this.mduty = state;
		  });
		  ...
		  mp.events.add('triggerDelayedEvent', (eventName, delay) => {
			  setTimeout(() => {
		  ...
		  mp.events.addDataHandler("syncedClothes", (entity, value, oldValue) => {
			  if (entity.type == "player") {
				  try {
					  if(entity.getVariable('syncedClothes')){
						  var clothes = JSON.parse(entity.getVariable('syncedClothes'));
						  for (const i in clothes) {
							  switch(i){
								  case "Hüte":
									  entity.setPropIndex(0, clothes[i].drawable, clothes[i].texture, true);
									  break;
								  case "Maske":
									  entity.setComponentVariation(1, clothes[i].drawable, clothes[i].texture, 0);
									  break;
								  case "Oberteil":
									  entity.setComponentVariation(11, clothes[i].drawable, clothes[i].texture, 0);
									  break;
								  case "Unterteil":
									  entity.setComponentVariation(8, clothes[i].drawable, clothes[i].texture, 0);
									  break;
								  case "Koerper":
									  entity.setComponentVariation(3, clothes[i].drawable, clothes[i].texture, 0);
									  break;
								  case "Hose":
									  entity.setComponentVariation(4, clothes[i].drawable, clothes[i].texture, 0);
									  break;
								  case "Schuhe":
									  entity.setComponentVariation(6, clothes[i].drawable, clothes[i].texture, 0);
									  break;
						  }
					  }
					  }
		  ...
		  mp.events.add('setPlayerDrunk', (player, state) => {
			  this.setPlayerDrunk(player, state);
				  ...
				  mp.events.add('setCloth', (slot, drawable, texture) => {
			  if(slot >= 1){
				  mp.players.local.setComponentVariation(slot, drawable, texture, 0);
			  } else {
		  ...
		  mp.discord.update('Hawaii Roleplay | Open Alpha |', 'https://discord.gg/XRPVqu3KAR');
	  }
  ...
  },{"../attachments/attachments":89,"../interfaces/hud/hud":123,"../interfaces/hud/player-panel":128,"../interfaces/hud/playernotification":129,"../utils/utils":163,"./contacts/contacts":158,"./telefonHistory/historys":161}],160:[function(require,module,exports){
  "use strict";
  ...
  },{"./history":160}],162:[function(require,module,exports){
  "use strict";
  ...
  },{"../player/player":159}],166:[function(require,module,exports){
  'use strict';
  
  require('./vehicle-module');
  
  },{"./vehicle-module":165}],167:[function(require,module,exports){
  "use strict";
  ...
  },{"../app/apps":3,"../apps/callManage":10,"../browser/browser":90,"../player/player":159}],168:[function(require,module,exports){
  "use strict";
  ...
  */
  ...
  },{"../browser/browser":90,"../components/component":91,"../peds/peds":155,"./windows":169}],169:[function(require,module,exports){
  "use strict";
